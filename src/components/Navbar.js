...
{/* <div className={`form-check form-switch text-${props.moode==='light'?'grey':'light'}`}>
  <input className="form-check-input mx-2" onClick={props.toggleMoode} type="checkbox" role="switch" id="flexSwitchCheckDefault"/>
